...
/**
 * Esta clase simula una fábrica de droids en el universo de Star Wars,
 * donde un ensamblador produce droids y un activador los activa,
 * utilizando una cola bloqueante para sincronizar el proceso.
 * @author Cesardrom
 */
