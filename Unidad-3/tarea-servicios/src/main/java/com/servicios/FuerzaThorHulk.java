...
/**
 * Esta clase simula una competencia de fuerza entre Thor y Hulk,
 * donde ambos levantan pesos durante un tiempo limitado, y se determina
 * el ganador por el total de peso levantado.
 * @author Cesardrom
 */
