...
/**
 * Esta clase simula la salvación de una ciudad en peligro por superhéroes
 * como Superman y Batman, quienes recorren zonas asignadas para neutralizar
 * la amenaza y determinar quién la resuelve primero.
 * @author Cesardrom
 */
