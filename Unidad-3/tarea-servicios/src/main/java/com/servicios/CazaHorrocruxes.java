...
/**
 * Esta clase simula la caza de Horrocruxes en el universo de Harry Potter,
 * donde varios buscadores (Harry, Hermione, Ron) compiten para encontrar
 * el Horrocrux primero en diferentes ubicaciones.
 * @author Cesardrom
 */
