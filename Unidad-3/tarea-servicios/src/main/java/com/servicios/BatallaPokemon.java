...
/**
 * Esta clase simula una batalla de Pokémon entre Pikachu y Charmander,
 * utilizando hilos con turnos alternos para representar los ataques.
 * Los Pokémon se turnan para atacar hasta que uno gane.
 * @author Cesardrom
 */
